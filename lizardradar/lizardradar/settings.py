"""
Django settings for lizardradar project.
...
# SECRET_KEY = 'django-insecure-y*wp96hopdwhon(p5!7zu#t*4sw4n#_1$)&-2c&s3$=*h7x7mi'
...
WSGI_APPLICATION = 'lizardradar.wsgi.application'
